SERVICES = {
    "basic_packages": {"pkgfile", "base-devel", "bash-completion", "yay", "rsync", "sudo", "dhcpcd", "grub", "freetype2", "fuse2", "dosfstools", "lzop", "efibootmgr", "libisoburn", "os-prober", "mtools", "linux-headers", "linux-docs"},
